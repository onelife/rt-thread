...
#   define STM32_USING_TYPE             'STM32F10X_HD'
#endif
// #define BSP_USING_LED1
// #define BSP_USING_LED2
#define BSP_USING_RTC
#define BSP_USING_USART1
// #define BSP_USING_SPISD               /* MicroSD card */
// #define BSP_USING_SDIOSD          	/* MicroSD card */
// #define BSP_USING_OLED                /* OLED (SSD1306) */
// #define BSP_USING_USB
// #define BSP_USING_USB_VIRTUAL_COM


#if (defined(BSP_USING_OLED) || defined(BSP_USING_SPISD))
#define BSP_USING_SPI2
#endif

#if defined(BSP_USING_SPISD)
#define SD_INTERFACE_SPI
#elif defined(BSP_USING_SDIOSD)
...
#if defined(BSP_USING_SPISD) || defined(BSP_USING_SDIOSD)
