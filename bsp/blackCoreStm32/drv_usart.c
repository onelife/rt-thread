...
#include "drv_usart.h"
#if (defined(BOARD_USING_USART1) || defined(BOARD_USING_USART2) || defined(BOARD_USING_USART3))
/* Private typedef -----------------------------------------------------------*/
/* Private define ------------------------------------------------------------*/
...
#if (defined(USART1) || defined(BOARD_USING_USART1))
...
#if (defined(USART2) || defined(BOARD_USING_USART2))
...
#if (defined(USART3) || defined(BOARD_USING_USART3))
...
#endif /* (defined(BOARD_USING_USART1) || defined(BOARD_USING_USART2) || defined(BOARD_USING_USART3)) */
/***************************************************************************//**
 * @}
 ******************************************************************************/
