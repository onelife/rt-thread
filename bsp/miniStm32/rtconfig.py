...
if os.getenv('RTT_CC'):
    ...
    PLATFORM = 'gcc'
    EXEC_PATH = 'C:/Tools/Sourcery_CodeBench_Lite_for_ARM_EABI/bin'
...
if PLATFORM == 'gcc':
    ...
    LFLAGS = DEVICE + ' -Wl,--gc-sections,-Map=RTT_miniStm32.map,-cref,-u,Reset_Handler -T stm32_rom.ld'
    ...
    POST_ACTION = OBJCPY + ' -O binary $TARGET RTT_miniStm32.bin\n' + SIZE + ' $TARGET \n'
